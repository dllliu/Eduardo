...
const exportAnimation = (character_id, gmsHashArray, product_name) => {
    ...
    const exportBody = {
        character_id,
        gms_hash: [{ "model-id": 103120902, "mirror": false, "trim": [0, 100], "overdrive": 0, "params": "0,0,0", "arm-space": 0, "inplace": true }], //gmsHashArray
        preferences: { format: "fbx7_unity", skin: "false", fps: "30", reducekf: "0" }, // To download collada use format: "dae_mixamo"
        product_name,
        type: "Motion"
    };
    const exportInit = {
